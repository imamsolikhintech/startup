    ...
    <div class="login-container">
      <n-card class="login-card">
        ...
        <n-form ref="formRef" :model="credentials" @submit.prevent="handleLogin" class="login-form">
          ...
          <n-button type="primary" size="large" :loading="authStore.loading" :disabled="!isFormValid" block class="mb-4"
            attr-type="submit">
            Sign In
          </n-button>
        ...
        <div class="social-login mb-4">
          <n-button secondary size="large" block class="mb-3" @click="handleSocialLogin('google')">
            <template #icon>
              <n-icon>
                <svg viewBox="0 0 24 24">
                  <path fill="currentColor"
